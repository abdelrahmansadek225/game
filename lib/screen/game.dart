          ...
          children: [
            ...
            Expanded(
              ...
              child: GridView.builder(
                itemCount: 9,
                gridDelegate:  const SliverGridDelegateWithFixedCrossAxisCount( // ui of grid
                crossAxisCount: 3, // there are 3 column in each row 
                ),
                itemBuilder: (BuildContext context , int index){ // itemBulder make 2d arrey
                return GestureDetector( // movement of user on grid
                  onTap:(){
                    _tapped(index);
                  } ,
                  child: Container(
      ...
      SizedBox(
        ...
        child: Stack(
          ...
          children: [
            ...
            Center(
              child: Text('$second' , style: const TextStyle(
